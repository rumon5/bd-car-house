      ...
      <section className="text-gray-600 bg-slate-100 py-9 my-10 body-font">
        <div className="container px-5  mx-auto">
          <div className="flex flex-col text-center w-full mb-10">
            <h1 className="text-2xl title-font text-gray-900 font-bold">
              OUR EXPERT TEAM
            </h1>
          </div>
          <div className="flex flex-wrap -m-4 mx-auto">
            {data.map((expert) => (
              <div key={expert._id} className="p-4 lg:w-1/4 md:w-1/2">
                <div className="h-full rounded-md flex flex-col items-center text-center bg-white p-5">
                  ...
                  <div className="w-full">
                    <h2 className="title-font text-lg mb-1 text-gray-900 font-semibold">
                      {expert.name}
                    </h2>
                    <h3 className="text-gray-500 mb-2 font-semibold">
                      {expert.phone}
                    </h3>
